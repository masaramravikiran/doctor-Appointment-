...
const Banner = () => {
  ...
  return (
    <div>
      <div>
        <div className='flex bg-primary rounded-lg px-6 sm:px-10 md:px-14 lg:px-122 my-20 md:mx-10'>
          {/*----Left Side----*/}
          <div className='flex-1 py-8 sm:py-10 md:py-16 lg:py-24 lg:pl-5'>
            <div className='text-x1 sm:text-2xl md:text-3xl lg:text-5xl font-semibold text-white'></div>
